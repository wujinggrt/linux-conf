...
" maximizer the current split window,
" and restore the size before.
" By
" :MaximizerToggle
...
" pasterd from
" http://stackoverflow.com/a/6271254/3625404
...
" <C-r><C-w> indicates the word under cursor
noremap <m-o> :Leaderf rg <C-r><C-w><Cr>
...
let g:Lf_PreviewResult = {'Function':1, 'BufTag':0, 'File':1, 'Line':1}
let g:Lf_PreviewInPopup = 1
"就可以启用这个功能，缺省未启用。 
"let g:Lf_PreviewHorizontalPosition = 100
...
for f in split(glob('~/.config/nvim/.vimconf/*.vim'), '\n')
	exe 'source' f
endfor
